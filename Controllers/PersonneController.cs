...
namespace Hotel.Controllers
{
	...
	public class PersonneController : ControllerBase
	{
        ...
        public ActionResult Get(string id)
        {
            ...
            {
                Personne obj = Repository.GetById(id).Result;
                if (obj == null)
        ...
        // POST: api/class/{obj}
        [HttpPost]
        public ActionResult Add(Personne obj)
        {
            try
            {
                Repository.Add(obj);
        ...
        // PUT: api/class/{obj}
        [HttpPut]
        public ActionResult Put(Personne obj)
        {
        ...
        [HttpDelete]
        public ActionResult Delete(Personne obj)
        {
